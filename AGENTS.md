...
- If a change affects design philosophy, page behavior, information architecture, module boundaries, styling systems, data schemas, bilingual strategy, or version strategy, update the relevant skill/reference file first, then implement the code change.
- If the codebase and the skill disagree, resolve the mismatch deliberately instead of silently choosing one side.
