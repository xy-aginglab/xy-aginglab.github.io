...
<div class="v2-home">
  ...
  <div class="v2-topic v2-clearfix" id="{{ dir.id }}">
    ...
    <div class="v2-topic__figure">
      <img src="{{ '/assets/img/research_rosacea.png' | relative_url }}" alt="玫瑰痤疮与化脓性汗腺炎">
    </div>
    {% elsif dir.id == 'hair' %}
    <div class="v2-topic__figure">
    ...
    <a class="v2-readmore" href="{{ dir.link_zh | default: dir.link | relative_url }}">了解更多</a>
  </div>
  {% endfor %}
  ...
  <div class="v2-dir-overview">
    ...
    <div class="v2-dir-grid">
      ...
      <div class="v2-dir-card">
        <h3>{{ dir.title_zh }}</h3>
        <p>{{ dir.summary_zh }}</p>
        <a href="{{ dir.link_zh | default: dir.link | relative_url }}">查看详情</a>
      </div>
      {% endfor %}
    </div>
  </div>
