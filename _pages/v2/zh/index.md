...
<div class="v2-home">
  ...
  <div class="v2-about">
    ...
    <div class="v2-about__mission">
      <p>本实验室立足<strong>临床皮肤病学</strong>与<strong>基础转化科学</strong>的交叉领域，聚焦<em style="font-style:normal;font-weight:700;">毛囊皮脂腺相关疾病</em>，包括<em style="font-style:normal;">玫瑰痤疮</em>、<em style="font-style:normal;">脱发</em>和<em style="font-style:normal;">白发</em>。我们将临床诊疗实践与疾病模式、自然史及治疗结局的临床研究相结合，同时依托丰富的患者资源开展机制研究。通过患者队列、多组学分析、疾病模型与转化实验，明确疾病发病机制，推进靶向治疗策略的开发，包括新型治疗药物的临床试验。</p>
      <p>我们同时研究<em style="font-style:normal;font-weight:700;">皮肤衰老</em>的基本机制，探索新型抗衰老干预策略。这些工作体现了我们整合临床洞察、生物学发现与治疗创新，推动精准皮肤病学发展的决心。</p>
      <p>相关成果发表于 <em>Cell</em>、<em>BMJ</em>、<em>Nature Medicine</em>、<em>Nature Communications</em>、<em>Developmental Cell</em>、<em>Science Advances</em>、<em>JAMA Dermatology</em>、<em>JAAD</em> 及 <em>JID</em> 等期刊，推动了从机制发现到临床转化的系统性进展。</p>
    </div>
  </div>
