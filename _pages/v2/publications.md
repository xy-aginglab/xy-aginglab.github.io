...
<div class="divide-y divide-gray-200">
  ...
  <div class="pt-6 pb-8 space-y-2 md:space-y-5">
    ...
    <p class="text-xl leading-8 text-gray-800">
      Papers from the Aging Biology Lab. See also <a href="https://scholar.google.com/citations?user={{ site.data.socials.scholar_userid }}">Google Scholar</a> for a complete list of publications.
    </p>
  </div>

  <!-- Key Papers — matches Papers.vue selectedPapers() -->
  <div class="selected-publications mb-8">
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1016/j.cell.2026.01.036" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1038/s41467-026-70153-4" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1038/s43587-025-00935-w" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1038/s41467-024-52946-7" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1038/s41467-024-50970-1" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1038/s41467-023-39761-2" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
      ...
      <div class="hover:shadow-lg hover:shadow-custom-orange flex flex-col gap-px rounded-lg w-full h-full overflow-hidden transition-shadow duration-300 ease-in-out">
        <a href="https://doi.org/10.1126/sciadv.abf2017" target="_blank" class="flex-grow bg-custom-soft no-underline p-4">
