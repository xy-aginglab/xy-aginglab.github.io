...
<div class="mx-auto max-w-4xl px-4 text-left flex flex-col">
  <div class="flex-grow">
    ...
    <p class="text-base sm:text-xl md:text-2xl lg:text-3xl text-gray-600 mt-2 lg:mt-4 select-none sm:whitespace-nowrap">
      ...
      <span id="rotating-text" class="italic" style="color:#a72126;background:rgba(167,33,38,0.1)">pilosebaceous unit diseases</span>
    </p>
    <p class="text-sm md:text-base lg:text-lg text-gray-500 mt-4 md:mt-6 lg:mt-12">
      In the <strong>Li Lab</strong>, we study pilosebaceous unit diseases and skin aging.
...
(function() {
  var items = [
    { text: 'pilosebaceous unit diseases', color: '#a72126', bg: 'rgba(167,33,38,0.1)' },
